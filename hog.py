...
def free_bacon(score):
    ...
    current_score = abs(score % 10 - score // 10) 
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        current_score = abs(opponent_score % 10 - opponent_score // 10) + 2
...
"""
1. say(score0, score1) should be called 
at the end of the first turn. 

2. Its return value (another commentary function) should be
called at the end of the second turn. 

3. Each consecutive turn, call the function that was returned 
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        previous_gain = (current_score - previous_score)


        if previous_gain == 1 and previous_gain > previous_high:
            print ("1 point! That's the biggest gain yet for", "Player", who) 

        elif previous_gain > 1 and previous_gain > previous_high: 
            print (previous_gain, "points! That's the biggest gain yet for", "Player", who)


        return announce_highest (who, max(previous_gain, previous_high), current_score)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls <= 10:
        ...
        average = make_averaged(roll_dice, num_samples)(num_rolls, dice)
